...
# LI-600 analysis
#
# Treatment effects on stomatal conductance (gsw)
#
# Comparisons:
...
#
#    Model:
#    gsw ~ treatment * day_factor + genotype + (1 | plantID)
#
...
#
# Day is treated as a categorical factor, corresponding
# to the genotype-adjusted analyses used for the overall
...
cat(
  "\nTreatment-effect analyses for gsw completed successfully.\n"
)
